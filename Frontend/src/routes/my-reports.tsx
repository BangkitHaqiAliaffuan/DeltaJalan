  ...
  return (
    <AppLayout>
      <div className="flex flex-col h-screen w-full bg-[#F5F7FA]">
        <header className="shrink-0 flex justify-between items-center px-4 py-2 bg-white border-b border-[#D0DAE8] h-[60px]">
          <div className="w-10" />
          <h1 className="font-headline-sm text-headline-sm font-semibold text-primary">
            Laporan Saya
          </h1>
