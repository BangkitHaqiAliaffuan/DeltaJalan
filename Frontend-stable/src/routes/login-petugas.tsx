...
export const Route = createFileRoute("/login-petugas")({
  component: PetugasLoginPage,
  head: () => ({
    meta: [
      { title: "Masuk Petugas — DeltaJalan" },
      {
        name: "description",
        content:
            ...
            >
              <div className="flex flex-col items-center pt-8 pb-6 px-8">
                ...
                <p className="text-center mt-2 font-body-sm text-body-sm text-[#475569] max-w-[280px] leading-relaxed">
                  Masuk sebagai Petugas — Dinas PU Bina Marga
                </p>
              </div>
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="relative flex items-center">
                      ...
                      <input
                        ...
                        placeholder="email@dispu.binamarga.go.id"
                        autoComplete="email"
