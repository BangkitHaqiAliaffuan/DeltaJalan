...
export function ConnectionBanner() {
  ...
  return (
    <div className="bg-amber-500 px-4 py-2 flex items-center justify-center gap-2 text-white text-[12px] font-semibold">
      ...
      Kamu sedang offline — isi data bisa disimpan sebagai draf
    </div>
  );
}
