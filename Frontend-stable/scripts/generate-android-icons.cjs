...
const LOGO = 'D:/JalanKita/Frontend-stable/dist/client/logo.png';
const RES_DIR = 'D:/JalanKita/Frontend-stable/android/app/src/main/res';
...
async function generate() {
  for (const [dir, size] of Object.entries(SIZES)) {
    ...
    const bg = await sharp({
      create: { width: size, height: size, channels: 4, background: { r: 30, g: 64, b: 175, alpha: 1 } }
    }).png().toBuffer();
